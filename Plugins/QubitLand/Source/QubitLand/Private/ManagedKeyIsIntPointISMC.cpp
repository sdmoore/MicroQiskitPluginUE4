...
#include "ManagedKeyIsIntPointISMC.h"

UManagedKeyIsIntPointISMC::UManagedKeyIsIntPointISMC() {};
UManagedKeyIsIntPointISMC::~UManagedKeyIsIntPointISMC() {};
void UManagedKeyIsIntPointISMC::GetFirstLastIndexForKey(
	FIntPoint InputKey,
	int32& RefFirstIndex,
	int32& RefLastIndex,
	bool& SuccessFlag) {
...
void UManagedKeyIsIntPointISMC::ClearAllKeys(
	bool& SuccessFlag) {
...
//void UManagedKeyIsIntPointISMC::AddValuesForGivenKey(
//	FIntPoint InputKey, 
...
//	return;
//}
void UManagedKeyIsIntPointISMC::RemoveKey(
	FIntPoint InputKey,
	bool& SuccessFlag) {
	int32 StartIndex, FinishIndex;
	bool ValidKey = false;
...
void UManagedKeyIsIntPointISMC::UpdateKeyWithArray(
	FIntPoint InputKey,
	TArray< FTransform >& InputTransformArray,
	bool& SuccessFlag) {
	int32 StartIndex, FinishIndex;
...
//void UManagedKeyIsIntPointISMC::AuditInternalData(bool SuccessFlag) {
//	int32 LocalSum = 0;
...
//bool UManagedKeyIsIntPointISMC::UpdateKeyWithSameSizeArray(
//	FIntPoint InputKey,
//	TArray< FTransform >& InputTransformArray) {
//	if(GetFirstLastIndexForKey(InputKey, StartIndex, FinishIndex))
//}
//bool UManagedKeyIsIntPointISMC::UpdateKeyWithDifferentSizeArray(
//	FIntPoint InputKey,
//	TArray< FTransform >& InputTransformArray) {
//
//}
UFUNCTION(BlueprintCallable, Category = "Custom Managed Instanced Static Mesh")
void UManagedKeyIsIntPointISMC::GetRatioTransformsForSingleKey(
	FIntPoint InputKey,
	int32 InputTick,
	int32 InputRatio,
	bool& SuccessFlag,
...
UFUNCTION(BlueprintCallable, Category = "Custom Managed Instanced Static Mesh")
void UManagedKeyIsIntPointISMC::GetRatioTransformsForAllKeys(
	int32 InputTick,
	int32 InputRatio,
	bool& SuccessFlag,
	TArray< FTransform >& OutputTransformArray,
	FVector InputScaling) {
	TArray<FIntPoint> LocalKeyArray;
